...
public class ShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product(2, "Reloj electronico honda", "Reloj de muy buena sincronicacion", 50, 1),
        ...
        modelBuilder.Entity<Client>().HasData(
                ...
                new Client(2, "Rolando Paz", "Av. 12 de Febrero")
            );
...
public record Product(int Id, string Nombre, string Decription, decimal Precio, int CategoryId)
{
